...
const NavigationProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // watch for user interactions without routes
    // popState is called when the user hits hte back button in the browser
  ...
  const navigate = (to) => {
    ...
    // we also need to update our currentPath in state so that our app rerenders and shows
    setCurrentPath(to);
  };
